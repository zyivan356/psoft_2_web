Я не могу создать и сохранить файл напрямую, но я могу предоставить вам содержимое файла README.md в формате, которое вы можете скопировать и сохранить самостоятельно.
